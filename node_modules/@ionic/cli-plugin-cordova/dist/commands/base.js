    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!isLiveReload) {
                ...
                yield configXmlUtils_1.writeConfigXmlContentSrc(this.env.project.directory, `${serverSettings.protocol || 'http'}://${serverSettings.externalAddress || serverSettings.publicIp}:${serverSettings.port || serverSettings.httpPort}`);
            }
